      ...
      <div>
        <div id="bg-home" className="text-white">
          <div className="grid grid-cols-12 items-center ">
            <NavLink to="/"><img className="md:col-span-3 col-span-3 ml-12 cursor-pointer" src="/SpaceX_Logo.png"></img></NavLink>
              <div className="md:col-span-11 col-span-11 flex justify-end pr-11">
